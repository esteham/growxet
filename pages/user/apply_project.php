...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $user->runQuery("INSERT INTO projects (project_name, description, project_img, categoryId, project_status, owner_id, shares, price_per_share, total_amount)
                             VALUES (:name, :desc, :img, :cat, 'pending', :owner, :shares, :pps, :total)");
    $stmt->execute([
        ':name' => $project_name,
        ':desc' => $description,
        ':img' => $imageName,
...
<div class="container card p-4 shadow">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <a href="/Web_Dev/Project/GrowNet/index.php?page=dashboard&pages=userproject" class="btn btn-secondary w-25">Cancel</a>
        </div>
    </form>
</div>
